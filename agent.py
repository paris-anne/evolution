...
class Agent(p.Particle):
	...
	def __init__(self, x=0, y=0, environment=None, size = 3.0, colour = (0, 0, 255), reproduce_level = 4.0,  food_level = float(2.0),
	 resistance = 0, reproduction = 2, dormancy_gene = 1, dormancy_time = 700, dormancy_period = 1400):
		super().__init__(x, y, size, colour)
		self.food_level = food_level
		self.fitness_cost = 1.0 #2.0
		self.size = size
