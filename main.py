...
run(first_dose = 25000, anti_conc = 0.05, anti_freq = 10000, anti_halflife = 800, skipped_doses = [2] , double_doses = [], numberofdoses = 20, numberofagents = 600) #first dose, anti_conc,
#changing_starttime()
