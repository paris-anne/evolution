...
# run(first_dose = 25000, anti_conc = 0.05, anti_freq = 10000, anti_halflife = 800, skipped_doses = [2] , double_doses = [3], numberofdoses = 20, numberofagents = 600) #first dose, anti_conc,

for i in range(1,10):
    run(first_dose = 0, anti_conc = 0.02, anti_freq = 16000, anti_halflife = 4000, skipped_doses = [i] , double_doses = [], numberofdoses = 10, numberofagents = 500) #first dose, anti_conc,
